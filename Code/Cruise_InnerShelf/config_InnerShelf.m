...
dir_base = fullfile(getenv('DATA'),'BowChain/InnerShelf/');
...
for i = 1:10
    ...
    switch i
      case 1
        config(i).zerop_dn = [7.3694774 7.3694786]*10^5;
      ...
      case 2
        config(i).zerop_dn = [7.369486251099537 7.369487526273148]*10^5;
      ...
      case 3
        config(i).zerop_dn = [7.369490073099884 7.369490353017691]*10^5;
      ...
      case 4
        config(i).zerop_dn = [7.369506163098032 7.369506245399306]*10^5;
      ...
      case 5
        config(i).zerop_dn = [7.369526243113426 7.369526249884259]*10^5;
      ...
      case 6
        config(i).zerop_dn = [7.369537182918634 7.369537294097223]*10^5;
      ...
      case 7
        config(i).zerop_dn = [7.369550225806452 7.369550474654378]*10^5;
      ...
      case 8
        config(i).zerop_dn = [7.369560657841435 7.369561625817476]*10^5;
      ...
      case 9
        config(i).zerop_dn = [7.369576073051736 7.369576382773959]*10^5;
      ...
      case 10
        config(i).zerop_dn = [7.369594591941551 7.369595382826967]*10^5;
