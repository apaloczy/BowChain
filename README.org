...
/Note that in the abscence of vertical sensor motion, x-offsets in instrument
position result in apparent time offsets under this model and can handled using
the same method./
